// Instrument data definitions for all 4 DG Nulmetingen assessments
    ...
    blocks: [
      ...
      },
      {
        ...
        tasks: [
          {
            id: 'A',
            instruction: 'Maak in School een map Biologie.',
            type: 'create-folder',
            targetPath: 'Bureaublad/School',
            folderName: 'Biologie'
          },
          {
            id: 'B',
            instruction: 'Verplaats huiswerk_cellen.docx naar School/Biologie.',
            type: 'move-file',
            sourcePath: 'Bureaublad/huiswerk_cellen.docx',
            targetPath: 'Bureaublad/School/Biologie'
          },
          {
            id: 'C',
            instruction: 'Verplaats spreekbeurt_aardrijkskunde.pptx uit Downloads naar School/Aardrijkskunde.',
            type: 'move-file',
            sourcePath: 'Bureaublad/Downloads/spreekbeurt_aardrijkskunde.pptx',
            targetPath: 'Bureaublad/School/Aardrijkskunde'
          },
          {
            id: 'D',
            instruction: 'Hernoem onbenoemd.docx naar werkstuk_geschiedenis.docx.',
            type: 'rename-file',
            sourcePath: 'Bureaublad/onbenoemd.docx',
            newName: 'werkstuk_geschiedenis.docx'
          },
          {
            id: 'E',
            instruction: 'Verplaats vakantie_strand.jpg naar Foto\'s.',
            type: 'move-file',
            sourcePath: 'Bureaublad/vakantie_strand.jpg',
            targetPath: 'Bureaublad/Foto\'s'
          }
        ],
        initialFileSystem: {
          'Bureaublad/': {
            'huiswerk_cellen.docx': { type: 'file' },
            'vakantie_strand.jpg': { type: 'file' },
            'onbenoemd.docx': { type: 'file' },
            'School': {
              type: 'folder',
              contents: {
                'Taal': {
                  type: 'folder',
                  contents: {
                    'Nederlands_proefwerk.docx': { type: 'file' }
                  }
                },
                'Aardrijkskunde': {
                  type: 'folder',
            ...
            'Foto\'s': {
              type: 'folder',
              contents: {
                'IMG_2034.jpg': { type: 'file' },
                'IMG_2035.jpg': { type: 'file' }
              }
            },
            'Downloads': {
              type: 'folder',
              contents: {
                'spreekbeurt_aardrijkskunde.pptx': { type: 'file' },
                'onbekend_bestand.png': { type: 'file' }
              }
            }
          }
        }
        ...
        items: [
          {
            ...
            mockupTitle: 'NOS - Artikel met auteur en bron',
          ...
          },
          {
            ...
            mockupTitle: 'TikTok - Anonieme post met angsttaal',
            judgeOptions: ['Ja', 'Twijfel', 'Nee', 'Weet ik niet'],
            correctJudgment: 'Nee',
            reasonOptions: [
          ...
          },
          {
            ...
            mockupTitle: 'Website met extreme claims',
            judgeOptions: ['Ja', 'Twijfel', 'Nee', 'Weet ik niet'],
            correctJudgment: 'Nee',
            reasonOptions: [
          ...
          },
          {
            ...
            mockupTitle: 'Schooltv-artikel met redacteur en expert',
            judgeOptions: ['Ja', 'Twijfel', 'Nee', 'Weet ik niet'],
            correctJudgment: 'Ja',
            reasonOptions: [
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            mockupTitle: 'Nepmail van Netflix',
            judgeOptions: ['Verdacht', 'Veilig', 'Weet ik niet'],
          ...
          },
          {
            ...
            mockupTitle: 'WhatsApp-bericht van "vriend"',
            judgeOptions: ['Verdacht', 'Veilig', 'Weet ik niet'],
            correctJudgment: 'Verdacht',
            featureOptions: [
