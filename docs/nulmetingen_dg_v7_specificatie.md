...
- Instructie: als er op afspelen wordt geklikt:
  - Bizzy zegt `Hoi!`.
  - Bizzy loopt 1 meter vooruit.
  - Bizzy draait naar 180 graden.
  - Bizzy denkt `Klaar!`.
- Scoring:
  - 1 punt: Bizzy zegt `Hoi!` met een zeg-blok.
  - 1 punt: `verplaats 1m vooruit` is gebruikt.
  - 1 punt: `draai 180 graden` is gebruikt.
  - 1 punt: eindgedrag en volgorde kloppen, inclusief `denkt Klaar!`, zonder kritieke afleider.
...
- Robot: Bizzy
- Score: 4 punten
- Opdracht: laat Bizzy `Klaar voor de start!` zeggen, drie keer 1 meter vooruit lopen met een herhaal-blok, en daarna naar 180 graden draaien.
- Scoring:
  - 1 punt: Bizzy zegt `Klaar voor de start!`.
  - 1 punt: `herhaal 3 keer` is aanwezig.
  - 1 punt: `verplaats 1m vooruit` staat genest in de herhaling.
  - 1 punt: eindgedrag klopt (3m vooruit, 180 graden gedraaid) zonder kritieke afleider.
...
- Robot: Bizzy
- Score: 4 punten
- Opdracht: Bizzy loopt een vierkant. Elke zijde is 1 meter; op elke hoek draait Bizzy 90 graden. Bizzy zegt vooraf `Start!` en denkt na afloop `Klaar!`.
- Scoring:
  - 1 punt: `herhaal 4 keer` is aanwezig.
  - 1 punt: binnen de herhaal-4 staan precies `verplaats 1m vooruit` en daarna `draai 90 graden`.
  - 1 punt: eindpositie en eindorientatie zijn terug bij start.
  - 1 punt: `Start!` wordt gezegd voor het lopen en `Klaar!` wordt gedacht na het lopen, zonder kritieke afleider.
...
- Robot: Bizzy
- Score: 4 punten
- Opdracht: Bizzy danst drie keer hetzelfde heen-en-weer-rondje: 2 meter vooruit, 180 graden draaien, 2 meter vooruit terug, 180 graden draaien. Aan het eind zegt hij `Bravo!`.
- Scoring:
  - 1 punt: `herhaal 3 keer` is aanwezig.
  - 1 punt: binnen de herhaal-3 staan precies `verplaats 2m vooruit`, `draai 180 graden`, `verplaats 2m vooruit`, `draai 180 graden`.
  - 1 punt: eindpositie en eindorientatie zijn terug bij start en `Bravo!` wordt na de herhaling gezegd.
  - 1 punt: er zijn geen parameter-afleiders gebruikt.
